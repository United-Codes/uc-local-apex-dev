...
If you're using macOS, [read the Podman setup guide](/other/podman-on-mac) for additional configuration steps.
...
Optionally [set up local SSL/HTTPS](/getting-started/common-tasks/#ssl-configuration) for ORDS.
